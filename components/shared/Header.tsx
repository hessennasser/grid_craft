...
export const Header: React.FC = () => {
    ...
    return (
        <header className="fixed w-full top-0 left-0 h-fit z-50 px-2 md:px-6 py-2">
            <div className="border-gray-200 dark:border-gray-700/50 bg-white dark:bg-gray-900/50 p-4 shadow-md container mx-auto flex justify-between items-center rounded-lg backdrop-blur-md">
